...
const STAKEHOLDER_DOCUMENTS = [
  ...
  { title: "CARNIVAL PORT AUTHORITY", path: "/stakeholders/CARNIWAL PORT AUTHORITY.pdf" },
  ...
  { title: "JSW JAIGARH PORT_1", path: "/stakeholders/JSW JAIGARH PORT_1.pdf" },
  ...
  { title: "MORMUGAO PORT AUTHORITY 3", path: "/stakeholders/MORMUGAO PORT AUTHORITY 3.pdf" },
  ...
  { title: "MS AMBUJA CEMENTS LTD2", path: "/stakeholders/S AMBUJA CEMENTS LTD.pdf" },
  { title: "MS COCHIN PORT AUTHORITY", path: "/stakeholders/S COCHIN PORT AUTHORITY.pdf" },
  { title: "MS HPCL - VISAKH REFINERY", path: "/stakeholders/S HPCL_VISAKH REFINERY.pdf" },
  { title: "MS JAWAHARLAL NEHRU PORT AUTHORITY, NAVI MUMBAI", path: "/stakeholders/S JAWAHARLAL NEHRU PORT AUTHORITY, NAVI MUMBAI.pdf" },
  { title: "MS KONKAN LNG LTD2", path: "/stakeholders/S KONKAN LNG LTD.pdf" },
  ...
  { title: "SIKKA PORTS & TERMINAL LTD", path: "/stakeholders/SIKKA PORTS and TERMINAL LTD.pdf" },
