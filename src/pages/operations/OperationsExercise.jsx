...
const DOCUMENTS = [
    {
        id: 'doc-1',
        label: 'Seminar exercise workshp and mockdrill',
        fileName: 'Seminar exercise workshp and mockdrill.pdf',
        path: '/servicesOprDocs/Seminar exercise workshp and mockdrill.pdf',
    },
];
...
/* =========================================================
   STANDALONE PAGE
========================================================= */
export default function OperationsExercise({ onBack }) {
